...
import { fetchProductById } from "./rentSlice";
...
const AnzeigeDetails: FC = () => {
  ...
  if (status === "loading") {
    return <Spinner show={true} color="red" />;
  }
    ...
    <div className="container mt-4 d-flex justify-content-center">
      ...
      >
        <div className="card-body text-center">
          ...
          <p>
            <strong>Preis pro Tag:</strong><span style={{ color: "red", fontWeight: "bold", fontSize: "20px"}}> {product.price} €</span>
          </p>
          {product.description && (
            <p>
          ...
          <button
            ...
            style={{ background: 'black', border: '1px solid #ccc', marginRight: "10px" }}
          >
            Schließen 
          </button>
        </div>
