...
const SignUp: React.FC = () => {
  ...
  const [exitSuccess, setExit] = useState(false);
  const exit = ()=>{
    navigate("/");
  }
  ...
  return (
    <>
      {exitSuccess ? (
        <ModalComponent
          show={exitSuccess}
          title="Sie sind registriert"
          content="Bestätigen. Der Brief wurde an Ihre E-Mail-Adresse gesendet."
          buttonContent="ok"
          danger={false}
          onClose={() => exit()}
        />
                ...
                <div className="form-group">
                  <label className="form-remember">
                    <input
                      ...
                      required
                    />{" "}
                    Ich stimme den Datenschutzbestimmungen und
